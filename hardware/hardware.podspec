Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/hardware.framework') || Dir.empty?('build/cocoapods/framework/hardware.framework')
        ...
        Kotlin framework 'hardware' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :hardware:generateDummyFramework
    ...
    spec.pod_target_xcconfig = {
        'KOTLIN_PROJECT_PATH' => ':hardware',
        'PRODUCT_MODULE_NAME' => 'hardware',
    }
